...
def average_lecturers_grade(course, lecturers):
    total_grades = []
...
print(f"Средняя оценка студентов на курсе Python: {average_students_grade('Python', students)}")
print(f"Средняя оценка лекторов на курсе Python: {average_lecturers_grade('Python', lecturers)}")
